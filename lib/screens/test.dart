...
class BookDetailsScreenTest extends StatefulWidget {
  BookDetailsScreenTest({
    Key? key,
  }) : super(key: key);
  @override
  State<BookDetailsScreenTest> createState() => _BookDetailsScreenStateTest();
}

class _BookDetailsScreenStateTest extends State<BookDetailsScreenTest>
      ...
      body: Stack(
        children: [
          SlidingUpPanel(
            ...
            body: MainImageWidget(images, onPageChange),
          ),
          Positioned(
            bottom: 70,
            left: 20,
