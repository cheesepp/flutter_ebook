          ...
          child: Column(
            children: [
              ...
              Container(
                  ...
                  child: TitleText.headlineLarge(context, text: 'Ví điện tử')),
              const SizedBox(
                height: 30,
              ),
              Container(
                ...
                child: Stack(
                  children: [
                    ...
                    const Positioned(
                      left: 20,
                      bottom: 30,
                      child: Text('Cập nhật từ ngày 30-7-2022'),
                    ),
                  ],
                ),
              ),
                  ...
                  itemBuilder: (_, index) {
                    return ListTile(
                      leading: Image.network(
                          'https://cdn-icons.flaticon.com/png/512/3298/premium/3298686.png?token=exp=1655195017~hmac=44b50c0dcd6f56e9dcff266e355a010c'),
                      title: Text('hehe boi'),
